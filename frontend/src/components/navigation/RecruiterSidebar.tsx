      ...
      <div className="p-4 border-t border-slate-800 flex items-center justify-between bg-slate-950/25">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-white truncate leading-tight">{user?.name || 'Recruiter'}</p>
            <p className="text-xxs text-slate-500 truncate leading-none mt-1">Acme Corp</p>
          </div>
        </div>
        <button
